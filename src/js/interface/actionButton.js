...
var ActionButton = function (game, parent, x, y, buttondKey, barKey, callbacks, callbackArguments, callbackContext, percentageFunction, percentageFunctionContext, timeFunction, timeFunctionContext,
    ...
    this.text = this.add(new ReactiveRichText(game, x, y + 2, this.button.width, textFunction.Fun(timeFunction, timeFunctionContext), {
        "font": "Minecraft",
        "fill": "#fff",
        "fontSize": 10,
        "align": "center"
    ...
    this.pressed = false;
    this._rechargeEvent = totalRechargeSignal.add(function () {
